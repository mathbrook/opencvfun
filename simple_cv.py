...
# 
# face_classifier = cv2.CascadeClassifier(cv2.samples.findFile("haarcascades/haarcascade_frontalface_default.xml"))
...
def face_detect():
    ...
    eye_cascade = cv2.CascadeClassifier(
        cv2.samples.findFile("haarcascades/haarcascade_eye.xml")
    )
